...
import dev.oudom.bank.card.dto.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleCardOperation(CardOperationException ex, HttpServletRequest request) {
